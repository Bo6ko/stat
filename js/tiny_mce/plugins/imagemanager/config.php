<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '/home/hypress2/www/uploads/'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '/home/hypress2/www/uploads/'; // absolute or relative from this script path, required.
	//$mcImageManagerConfig['filesystem.path'] = 'C:/xampp/htdocs/miamirent/uploads/'; // absolute or relative from this script path, optional.
	//$mcImageManagerConfig['filesystem.rootpath'] = 'C:/xampp/htdocs/miamirent/uploads/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.enabled'] = false; // false default, verify that you have GD on your server
